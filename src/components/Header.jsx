...
const Header = () => {
  ...
  return (
    ...
    lg:bg-n-8/90 lg:blackdrop-blur-sm ${openNavigation ? 'bg-n-8' : 'bg-n-8/90 blackdrop-blur-sm'}`}>
    
      <div className="flex items-center justify-between px-5 lg:px-7.5 xl:px-10 mx-lg:py-4">
        ...
        bg-n-8 lg:static lg:flex lg:mx-auto lg:bg-transparent`}>
          ...
          justify-center m-auto lg:flex-row">
            ...
            {navigation.map((item) => (
              ...
              px-6 py-6 md:py-8 lg:-mr-0.25 lg:text-xs lg:font-
        ...
        <div className="hidden lg:flex items-center gap-4">
          <a href="#signup" className="button mr-8 text-n-1/50 transition-colors hover:text-n-1 lg:block">
              New Account
          </a>
